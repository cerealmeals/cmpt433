...
#define LED_0_OFFSET           (MEM_START_OFFSET)
#define LED_1_OFFSET           (LED_0_OFFSET + sizeof(uint32_t))
...
// Then a single uint8_t flag
#define LED_FLAG_OFFSET        (LED_7_OFFSET + sizeof(uint32_t))

// Finally, mark the end of our used memory space
#define END_MEMORY_OFFSET      (LED_FLAG_OFFSET + sizeof(uint8_t))
